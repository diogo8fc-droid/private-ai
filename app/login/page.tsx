'use client'; // Esta linha protege contra erros, mesmo que não seja estritamente necessária aqui
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-950 text-white font-sans relative overflow-hidden">
      ...
      {/* Imagem de Fundo - Certifica-te que tens login-bg.jpg na pasta public */}
      ...
      <div className="w-full max-w-md bg-neutral-900/60 backdrop-blur-xl p-8 rounded-2xl border border-purple-500/20 shadow-2xl z-10 mx-4">
        ...
        {/* Inputs Visuais (Sem <form> para não dar erro) */}
        <div className="space-y-5">
          <input 
            type="email" 
            placeholder="Email" 
            className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-purple-500 transition"
          />
          <input 
            type="password" 
